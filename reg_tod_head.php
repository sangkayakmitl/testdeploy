    ...
    <div class="row-fluid">
        ...
        <div class="col-md-5">
            <div class="row-fluid">
                ...
                <form action="reg_tod_head_action.php" method="post">
                <div class="col-md-12">
                    <div class="panel panel-info text-center form-group" id="input-info">
                        <div class="panel-heading"><label for="reg-detail"><h1>แทงโต๊ดหัว</h1></label></div>
                ...
                <div class="col-md-12">
                    ...
                    <button type="reset" class="btn btn-danger text-center" value="clear">ล้างข้อมูล</button>
                    </div>
                </div>
