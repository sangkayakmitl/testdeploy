            ...
            echo '<div class="row-fluid">
                    <div class="col-md-8 offset2 text-center"><br><br>
                        <div class="panel panel-primary">
                            <div class="panel-heading">กำลังทำการแก้ไข record '.$_GET['trasectionid'].' ที่มีปัญหา ( '.$oldlotto_type.' )</div>
                                <div class="panel-body">

                                    <div class="row-fluid">
                                      <form class="form-inline" action="editlotto_action.php" method="post">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="test" value="'.$oldlotto_price.'" class="form-control" id="new_lotto_price"  name="old_lotto_price" disabled="">
                                        </div><br><br>
                                        ...
                                        <div class="form-group">
                                          <label for="new_lotto_number">Lotto Number:</label>
                                          <input type="text" class="form-control" id="new_lotto_number" placeholder="New Lotto Number" name="new_lotto_number">
                                        </div>
                                        <div class="form-group">
                                          <label for="new_lotto_price">Lotto Price:</label>
                                          <input type="test" class="form-control" id="new_lotto_price" placeholder="New Lotto Price" name="new_lotto_price">
                                        </div><br><br>
                                        <button type="submit" class="btn btn-success">Submit</button>
                                        <a href="view_error_all.php" id="cancel" name="cancel" class="btn btn-danger">Cancel</a>
