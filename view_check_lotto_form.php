                        ...
                        <div class="panel panel-success" id="report-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6 col-md-offset-3 form-group well">
                                    ...
                                    <form class="form-inline text-center" action="view_check_lotto_report.php" method="post">
                                        <H1>รางวัลที่หนึ่ง</H1><br>             
                                        <label for="big_prize"></label>
                                        <input class="form-control input-aplotto text-center" value=<?php echo $big_prize; ?> name="big_prize"  style="width: 150px" id="big_prize" placeholder="รางวัลที่1">
                                        <br><br>
                                        <H1>สี่ครั้ง</H1><br>                                               
